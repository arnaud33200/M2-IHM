package  {
	...
	// plus personne est devant la porte mais il faut attendre
	// la fermeture avant de continué
...
// en cas de shoot réussit, ajout du temps suplémentaire pour
// voir les informations sur le bandit tué
		public function changeCloseTimer(t:int):void {
			closeTimer = new Timer(t, 1);
			closeTimer.addEventListener(TimerEvent.TIMER, doorCloseEnd);
		}
		
// Démarrer l'arrivé d'une nouvelle personne
...
// calcule d'un bon shoot en fonction du temps entre le tire 
